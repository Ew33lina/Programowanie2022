...
############ Zmienne; typ prosty (klasy): string, integer, float, bool ###############
# print('Hello world')  
...
# p2 = sqrt(4) # paradygmat programowania funkcyjnego
# print(p2)  
...
# zmienna_x = int(input("zmienna_x "))
# zmienna_y = int(input("zmienna_y "))
# zmienna_c= 2*(zmienna_x) + 5*(zmienna_y)
# print(zmienna_c)
...
# wiek = int(input("wiek "))
# kierunek = str(input('kierunek '))
# print("Jestem {} {} mam {} lat studiuję {}".format(imie,nazwisko,wiek,kierunek))

## 5. Sprawdź/porównaj czy 1+2+10+20000001+4+347586970885 jest równa 321784560456434534646

# b = 321784560456434534646
# print('sa') if(1+2+10+20000001+4+347586970885==b) else print('nie sa')
...
##   użyj operatora modulo % który zwraca resztę z dzielenia  np. 5%2   czyli 2 reszta 1

# a = int(input("a "))
# b = int(input("b "))
# suma = (a+b)
# print(suma)
# print("parzysta") if(suma%2==0) else print("nie jest")
...
# pierwsza_liczba = int(input("pierwsza_liczba"))
# druga_liczba = int(input("druga_liczba"))
# suma = (pierwsza_liczba + druga_liczba)
# różnica = (pierwsza_liczba - druga_liczba)
# iloczyn = (pierwsza_liczba * druga_liczba)
# iloraz = (pierwsza_liczba / druga_liczba)
# print("suma = {} różnica = {} iloczyn = {}  iloraz = {}".format(suma,różnica,iloczyn,iloraz))

## 8. Dla dowolnego x sprawdź wynik działań (x > 1 and x < 13) oraz (x != 5 or x < 0)
# Zadania dodatkowe:
...
# wiek = int(input("wiek "))
# zdrowo = input("Czy odżywiasz sie zdrowo? ")
# sport = input("Czy lubisz sport? ")
# hobby = input("Co jest Twoim hobby? ")
# czas = input("Jak lubisz spędzać wolny czas? ")
# zawód = input("Kim jesteś z zawodu? ")
# print("Nazywam się {} {}, mam {} lat. Czy zdrowo się odżywiam? {} Czy lubię sport? {}Moim hobby jest {}. W wolnym czasie lubię: {}.Z zawodu jestem {}".format(imie,nazwisko,wiek,zdrowo,sport,hobby,czas,zawód))
